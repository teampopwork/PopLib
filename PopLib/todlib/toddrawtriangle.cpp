...
#endif
void	funcname(SWHelper::SWVertex* pVerts, void* pFrameBuffer, const uint32_t bytepitch, const SWHelper::SWTextureInfo* textureInfo, SWHelper::SWDiffuse& globalDiffuse)
{
