...
WidgetManager::WidgetManager(AppBase *theApp)
{
	mApp = theApp;
...
{
	AUTO_PERF("WidgetManager::DrawScreen");
...
{
	AUTO_PERF("WidgetManager::UpdateFrame");
...
bool WidgetManager::KeyChar(PopChar theChar)
{
	mLastInputUpdateCnt = mUpdateCnt;
